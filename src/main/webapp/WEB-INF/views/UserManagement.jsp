...
<body ng-app="myApp" class="ng-cloak">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users">
                              ...
                              <td>
                             <div class="btn-edit-remove"> <button type="button" ng-click="ctrl.edit(u.id)" class="btn btn-success custom-width">Edit</button></div>
                              <div class="btn-edit-remove"> <button type="button" ng-click="ctrl.remove(u.id)" class="btn btn-danger custom-width">Remove</button></div>
                              </td>
                          </tr>
                      </tbody>
                  </table>
     ...
     <script src="<c:url value='/static/js/security/authInterceptor.js' />"></script>
